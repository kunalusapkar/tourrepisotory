...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia3VuYWx1c2Fwa2FyIiwiYSI6ImNrMnZwMHcyczA3Z20zbnFtc21teWZvOGMifQ.wa4yOmuHzay7--t_EtsuvQ';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup().setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ":").concat(loc.description, "</p>")).addTo(map);
    new mapboxgl.Popup({
      offset: 30
...
/* eslint-disable */
var stripe = Stripe('pk_test_wCRT98QMNlUTRBfywGolspY000sk0p4XPW');
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap((0, _axios.default)("http://localhost:3000/api/v1/bookings/checkout-session/".concat(tourId)));
    ...
    return regeneratorRuntime.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn--save-password').innerHTML = 'Upadting...';
